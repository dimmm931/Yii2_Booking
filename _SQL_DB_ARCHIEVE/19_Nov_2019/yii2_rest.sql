...
--
-- Хост: 127.0.0.1:3306
-- Час створення: Лис 19 2019 р., 17:38
...
INSERT INTO `bot` (`b_id`, `b_category`, `b_key`, `b_reply`) VALUES
(2, 'Statements', 'What about weather? // What is the weather like now in EU?', 'It is great weather today // It is windy today // it is raining // I like the weather we have today // It is sunny // It is stormy'),
(3, 'Statements', 'Wht is your name? // Who are you?', 'You can call me Bot // I am not too much about names'),
(4, 'Statements', 'Hello // Hi // How do you do? // Good morning', 'Hello // Hi // How do you do? // Good morning // Good everning // Greetings // Hey, brother'),
(6, 'Statements', 'Copenhagen // Cph', 'I like CPH // Copenhagen is a Scandinavian city // I like Rafshaleoen mostly // Tegneholmen is the pure waterfront experience // København was a Danish five-masted barque used as a naval training vessel until its disappearance after December 22, 1928.'),
(7, 'Statements', 'Dnb', 'Caly and Teebee');
